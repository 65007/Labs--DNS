...
+--------------+-----------------------+-----------------------------+
| grpX-resolv1 | 100.100.X.67 (eth0)   | fd06:28fd:X:64::67 (eth0)   |
+--------------+-----------------------+-----------------------------+
| grpX-resolv2 | 100.100.X.68 (eth0)   | fd06:28fd:X:64::68 (eth0)   |
+--------------+-----------------------+-----------------------------+
| grpX-rtr     | 100.64.1.X (eth0)     | fd06:28fd:X::1 (eth1)       |
|              | 100.100.X.65 (eth2)   | fd06:28fd:X:64::1 (eth2)    |
|              | 100.100.X.193 (eth4)  | fd06:28fd:X:192::1 (eth4)   |
|              | 100.100.X.129 (eth3)  | fd06:28fd:X:128::1 (eth3)   |
|              | 100.100.X.1 (eth1)    | fd06:28fd:0:1::X (eth0)     |
+--------------+-----------------------+-----------------------------+
```
...
server:
        ...
        access-control: fd06:28fd::/32 allow
